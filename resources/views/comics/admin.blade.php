    ...
    <div class="container py-5">
        <div class="row">
            ...
            <table class=" overflow-auto">
                <thead>
                    <tr>
                        <th scope="col"><span class=" d-none d-sm-block text-white">Nome</span></th>
                        <th scope="col"><span class="d-none d-sm-block text-white">Prezzo</span></th>
                        <th scope="col"><span class="d-none d-md-block text-white">Stato</span></th>
                        <th scope="col" class="text-center"><span class="text-white">Azione</span></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="col-1 flex-grow-1">
                                    <div class="ms-3">
                                        ...
                                        <span class="text-secondary d-none d-xl-block"></span>
                                    </div>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="d-flex py-2">
                                <span class=" text-center d-none d-sm-block"></span>
                            </div>
                        </td>
                        <td>
